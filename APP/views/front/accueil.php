...
<div class="image-accueil">
    <div>
        <!-- <img class="" src="tototototo\public\front\images\images\huitre (2).jpg" alt="huitre bretagne"> -->
    </div>
</div>

<div class="about row" >
    <!-- <div class="photo-about col-6">
        <img src="tototototo\public\front\images\images\huitre (11).jpg" alt="huitre bretagne">
        <img src="tototototo\public\front\images\images\huitre (14).jpg" alt="huitre bretagne">
    </div> -->
